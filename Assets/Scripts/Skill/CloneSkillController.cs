...
public class CloneSkillController : MonoBehaviour
{
    ...
    {
        Collider2D[] colliders = Physics2D.OverlapCircleAll(attackCheck.position, player.attackCheckRadius, player.enemyLayer);
    ...
    {
        Collider2D[] colliders = Physics2D.OverlapCircleAll(transform.position, detectEnemyRadius, player.enemyLayer);
